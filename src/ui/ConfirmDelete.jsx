...
function ConfirmDelete({ onConfirm, disabled, onCloseModal }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-teal-800 opacity-95 ">
      <div className="flex w-3/4 flex-col gap-3 rounded-md border-2 border-white p-10 text-white shadow-xl">
